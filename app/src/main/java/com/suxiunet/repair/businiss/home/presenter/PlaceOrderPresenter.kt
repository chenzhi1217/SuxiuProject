...
class PlaceOrderPresenter : BasicPresenter<PlaceOrderContract.View, PlaceOrderContract.Model> {
     ...
     * 产生订单
     */
    fun placeOrder(name: String, phone: String, time: String, style: String, equModel: String, addrs: String, street: String, desc: String) {
        if (!checkData(name, phone, "2017-15-02", equModel, addrs, desc)) {
            return
        }
     ...
     * 判断数据的准确性
     */
    fun checkData(name: String, phone: String, time: String,equModel: String, addrs: String, desc: String): Boolean {
